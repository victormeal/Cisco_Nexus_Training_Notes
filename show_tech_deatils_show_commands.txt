...
`show system internal confcheck event-history errors`
...
`show ip arp internal event-history suppression-event`
...
`show ip internal event-history ppf`
`show ip stats`
...
`show diagnostic internal port_lb trace`
...
}`show system internal dme startup-config`
...
`show routing internal event-history add-route filter vrf all`
...
`show bgp private debug history all`
...
`show flow internal event-history lif`
...
`show monitor internal event-history session 3`
...
`show system internal monitorc info cfg-events`
...
`show system internal l2fm info stagedb`
...
`show system internal iftmc info pss stats`
...
`show hardware internal tah sdk event-history l3-error`
...
2021 Jun 02 23:34:09.396452: E_STRING    tahusd_xcvr_poll_max_temp_handler(13841): [inst=0 nxosport=16 mifpga_port:5] This SFP does not support DOM`show hardware internal tah mac hwlib show global_mac_status fp-port 5 `
...
2021 Jun 02 13:22:21.496891: E_STRING    tahusd_xcvr_cmn_init(8713): [inst=0 nxosport=48 mifpga_port:13] Inited the sdwrap for nxos port 48`show hardware internal tah mac hwlib show global_mac_status fp-port 13 `
...
2021 Jun 02 13:22:21.497661: E_STRING    tahusd_xcvr_cmn_init(8713): [inst=0 nxosport=80 mifpga_port:21] Inited the sdwrap for nxos port 80`show hardware internal tah mac hwlib show global_mac_status fp-port 21 `
...
2021 Jun 02 13:22:21.498461: E_STRING    tahusd_xcvr_cmn_init(8713): [inst=0 nxosport=112 mifpga_port:29] Inited the sdwrap for nxos port 112`show hardware internal tah mac hwlib show global_mac_status fp-port 29 `
...
2021 Jun 02 13:22:21.499267: E_STRING    tahusd_xcvr_cmn_init(8713): [inst=0 nxosport=144 mifpga_port:37] Inited the sdwrap for nxos port 144`show hardware internal tah mac hwlib show global_mac_status fp-port 37 `
...
2021 Jun 02 13:22:21.500090: E_STRING    tahusd_xcvr_cmn_init(8713): [inst=0 nxosport=176 mifpga_port:45] Inited the sdwrap for nxos port 176`show hardware internal tah mac hwlib show global_mac_status fp-port 45 `
...
`show hardware internal tah event-history front-port 53 `
...
`show forwarding internal msgs`
`show forwarding route summary vrf all`
`show forwarding route platform max-display-count 100000 vrf all`
`show forwarding ipv6 route summary vrf all`
`show forwarding ipv6 route platform max-display-count 100000 vrf all`
`show forwarding vrf all adjacency platform`
`show forwarding vrf all ipv6 adjacency platform`
`show forwarding ecmp platform`
`show forwarding ecmp recursive platform max-display-count 1000`
`show forwarding route recursive platform vrf all`
`show system internal forwarding route summary`
`show forwarding route platform vrf all`
`show forwarding ipv6 route platform vrf all`
`show system internal forwarding ipv6 route summary`
`show system internal forwarding vrf all adjacency`
`show system internal forwarding vrf all ipv6 adjacency`
`show system internal forwarding unicast counters`
`show forwarding internal trace v4-adj-history`
`show forwarding internal trace v4-pfx-history`
`show forwarding internal trace v4-rnh-history`
`show forwarding internal trace v6-adj-history`
`show forwarding internal trace v6-pfx-history`
`show forwarding internal trace v6-rnh-history`
`show forwarding internal trace vobj-history`
`show forwarding internal trace ecmp-history`
`show system internal ipfib errors`
`show system internal ipfib msgs`
`show system internal ipfib event-history errors`
`show system internal ipfib event-history msgs`
`show forwarding distribution clients`
`show forwarding distribution fib-state`
`show forwarding distribution internal debugs`
`show forwarding distribution internal counters`
`show forwarding distribution internal errors`
`show forwarding distribution internal info`
`show forwarding distribution internal msgs`
`show system internal ufdm mem-stats detail`
`show hardware rate-limit`
`show forwarding distribution peer-id vpls`
`show forwarding distribution peer-id otv`
`show forwarding distribution internal es-pathlist 2`
`show tech-support rpm`
`show ipv6 prefix-list`
`show tech-support l3vm`
`show tech-support netstack`
`show tech-support routing ipv4 unicast`
`show tech-support routing ipv6 unicast`
`show system internal sysmgr service name u6rib`
`show routing ipv6 detail vrf all`
`show routing ipv6 recursive-next-hop vrf all`
`show routing ipv6 clients vrf all`
`show routing ipv6 internal vrf all`
`show routing ipv6 summary vrf all`
`show system internal pss dump volatile:/dev/shm/u6rib_runtime_pss`
`show logging logfile | grep -i u6rib`
`show routing ipv6 unicast internal ufdm`
`show routing ipv6 unicast internal buffers`
`show routing ipv6 internal event-history statistics`
`show routing ipv6 internal event-history general`
`show routing ipv6 internal event-history detail`
`show routing ipv6 internal event-history summary`
`show routing ipv6 internal event-history ufdm`
`show routing ipv6 internal event-history ufdm-summary`
`show routing ipv6 internal event-history ufdm-detail`
`show routing ipv6 internal event-history am`
`show routing ipv6 internal event-history recursive-next-hop`
`show routing ipv6 internal event-history msgs`
`show routing ipv6 internal event-history errors`
`show routing ipv6 internal event-history ha`
`show routing ipv6 internal event-history lfe`
`show routing ipv6 internal event-history dme`
`show routing ipv6 internal event-history sidmgr`
`show srv6 manager`
`show srv6 locator detail`
`show srv6 sid detail`
`show srv6 clients`
`show srv6 internal`
`show routing ipv6 memory statistics`
`show routing ipv6 internal mem-stats all detail`
`show routing vrf all ipv6 internal distribution`
`show ipv6 interface brief vrf all`
`show tech-support aclmgr`
`show system internal access-list copp stats`
`show system internal access-list copp stats stage1`
`show system internal access-list copp stats stage2`
`show system internal access-list`
`show system internal access-list resource utilization`
`show system internal access-list resource ipv6-compression detail`
`show system internal access-list resource l4ops detail`
`show system internal access-list resource redirect detail`
`show system internal aclqos info spl database summary`
`show system internal aclqos event-history trace | head lines 2000`
`show system internal aclqos info fex`
`show system internal aclqos info mcm`
`show tech-support im`
...
`show feature | grep mpls`
`show forwarding internal mpls trace adj-history`
`show forwarding internal mpls trace ecmp-history`
`show forwarding internal mpls trace label-history`
`show forwarding internal mpls trace te-history`
`show forwarding mpls vrf all`
`show forwarding ipv4 adjacency mpls`
`show forwarding ipv6 adjacency mpls`
`show forwarding adjacency mpls stats`
`show forwarding internal mpls counters`
`show forwarding internal ipfib debugs`
`show forwarding internal errors`
`show forwarding mpls drop-stats`
`show forwarding mpls ecmp`
`show forwarding mpls platform`
...
`show system internal ethpm lock`
      0x0000:  02 01 00 00 00 00 00 02 `show system internal ethpm mem-stats`
`show system internal ethpm msgs`
`show system internal ethpm info all`
`show system internal im errors`
`show system internal im info global`
`show system internal im lock`
      0x0000:  00 00 00 00 00 00 00 01 `show system internal im mem-stats`
`show system internal im msgs`
`show tech-support pixmc-all`
`show tech-support fib-all`
`show tech-support nia`
`show version | section Software`
`show system internal sysmgr service name nia-mgr`
`show install active | inc nia`
`show install inactive | inc nia`
`show install patches`
`show install committed`
`show install log`
`show port-channel database | json-pretty`
`show nia internal info`
`show nia log`
`show nia nxsdk state`
`show nia nxsdk mem-stats all`
`show nia nxsdk event-history events`
